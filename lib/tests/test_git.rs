...
fn test_reset_head_with_index_no_conflict() {
    ...
    let tree_id = testutils::create_tree(&repo, |builder| {
        builder
            .entry(repo_path("some/dir/normal-file"))
            .text_file("file\n")
            .executable(false);
        builder
            .entry(repo_path("some/dir/executable-file"))
            .text_file("file\n")
            .executable(true);
        builder
            .entry(repo_path("some/dir/symlink"))
            .symlink("./normal-file");
        builder
            .entry(repo_path("some/dir/commit"))
            .submodule(testutils::write_random_commit(mut_repo).id().clone());
    })
    .id();
...
fn test_reset_head_with_index_merge_conflict() {
    ...
    let base_tree_id = testutils::create_tree(&repo, |builder| {
        builder
            .entry(repo_path("some/dir/normal-file"))
            .text_file("base\n")
            .executable(false);
    ...
    let left_tree_id = testutils::create_tree(&repo, |builder| {
        builder
            .entry(repo_path("some/dir/normal-file"))
            .text_file("left\n")
            .executable(false);
    ...
    let right_tree_id = testutils::create_tree(&repo, |builder| {
        builder
            .entry(repo_path("some/dir/normal-file"))
            .text_file("right\n")
            .executable(false);
...
fn test_reset_head_with_index_file_directory_conflict() {
    ...
    let left_tree_id = testutils::create_tree(&repo, |builder| {
        builder.entry(repo_path("test/dir/file")).text_file("dir\n");
    })
    .id();
    let right_tree_id = testutils::create_tree(&repo, |builder| {
        builder.entry(repo_path("test")).text_file("file\n");
    })
    .id();

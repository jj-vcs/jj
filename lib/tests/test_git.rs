...
fn test_reset_head_with_index_no_conflict() {
    ...
    let tree_id = testutils::create_tree(
        &repo,
        [
            (
                repo_path("some/dir/normal-file"),
                testutils::DirEntry::text_file("file\n").executable(false),
            ),
            (
            ...
            (
                ...
                testutils::DirEntry::symlink("./normal-file"),
            ),
            (
                repo_path("some/dir/commit"),
                testutils::DirEntry::submodule(
...
fn test_reset_head_with_index_merge_conflict() {
    ...
    let base_tree_id = testutils::create_tree(
        &repo,
        [
            (
                repo_path("some/dir/normal-file"),
                testutils::DirEntry::text_file("base\n").executable(false),
            ),
            (
                repo_path("some/dir/executable-file"),
                testutils::DirEntry::text_file("base\n").executable(true),
    ...
    let left_tree_id = testutils::create_tree(
        &repo,
        [
            (
                repo_path("some/dir/normal-file"),
                testutils::DirEntry::text_file("left\n").executable(false),
            ),
            (
                repo_path("some/dir/executable-file"),
                testutils::DirEntry::text_file("left\n").executable(true),
            ...
            (
                repo_path("some/dir/symlink"),
                testutils::DirEntry::symlink("./executable-file"),
            ),
            (
                repo_path("some/dir/commit"),
                testutils::DirEntry::submodule(
    ...
    let right_tree_id = testutils::create_tree(
        &repo,
        [
            (
                repo_path("some/dir/normal-file"),
                testutils::DirEntry::text_file("right\n").executable(false),
            ),
            (
                repo_path("some/dir/executable-file"),
                testutils::DirEntry::text_file("right\n").executable(true),
            ...
            (
                repo_path("some/dir/symlink"),
                testutils::DirEntry::symlink("./commit"),
            ),
            (
                repo_path("some/dir/commit"),
                testutils::DirEntry::submodule(
...
fn test_reset_head_with_index_file_directory_conflict() {
    ...
    let left_tree_id = testutils::create_tree(&repo, [(repo_path("test/dir/file"), "dir\n")]).id();
    let right_tree_id = testutils::create_tree(&repo, [(repo_path("test"), "file\n")]).id();

 ...
 * `jj metaedit --update-committer-timestamp` is deprecated in favor of
   `jj metaedit --force-rewrite`. The former would not update _only_ the
   committer timestamp, as its name implies, but also the committer name and
   email.

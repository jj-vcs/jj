...
fn test_status_display_relevant_working_commit_conflict_hints() {
    ...
    insta::assert_snapshot!(output, @r"
    @  yqosqzyt test.user@example.com 2001-02-03 08:05:13 725f6eb3 (conflict)
    │  (empty) boom-cont-2
    ×  royxmykx test.user@example.com 2001-02-03 08:05:12 a5e8daac (conflict)
    │  (empty) boom-cont
    ×    mzvwutvl test.user@example.com 2001-02-03 08:05:11 9614e217 (conflict)
    ├─╮  (empty) boom
    ...
    insta::assert_snapshot!(output, @r"
    The working copy has no changes.
    Working copy  (@) : yqosqzyt 725f6eb3 (conflict) (empty) boom-cont-2
    Parent commit (@-): royxmykx a5e8daac (conflict) (empty) boom-cont
    ...
    insta::assert_snapshot!(output, @r"
    The working copy has no changes.
    Working copy  (@) : [1m[38;5;13my[38;5;8mqosqzyt[39m [38;5;12m7[38;5;8m25f6eb3[39m [38;5;9m(conflict)[39m [38;5;10m(empty)[39m boom-cont-2[0m
    Parent commit (@-): [1m[38;5;5mr[0m[38;5;8moyxmykx[39m [1m[38;5;4ma[0m[38;5;8m5e8daac[39m [38;5;1m(conflict)[39m [38;5;2m(empty)[39m boom-cont
    ...
    insta::assert_snapshot!(output, @r"
    @  wqnwkozp test.user@example.com 2001-02-03 08:05:20 a4f66021
    │  fixed 2
    ○  kmkuslsw test.user@example.com 2001-02-03 08:05:19 f780040f
    │  fixed 1
    ×  yqosqzyt test.user@example.com 2001-02-03 08:05:13 725f6eb3 (conflict)
    │  (empty) boom-cont-2
    ×  royxmykx test.user@example.com 2001-02-03 08:05:12 a5e8daac (conflict)
    ...
    Working copy changes:
    M conflicted.txt
    Working copy  (@) : wqnwkozp a4f66021 fixed 2
    Parent commit (@-): kmkuslsw f780040f fixed 1
    [EOF]
    ");
    ...
    Working copy changes:
    M conflicted.txt
    Working copy  (@) : kmkuslsw f780040f fixed 1
    Parent commit (@-): yqosqzyt 725f6eb3 (conflict) (empty) boom-cont-2

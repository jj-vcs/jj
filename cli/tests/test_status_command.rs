...
fn test_status_display_relevant_working_commit_conflict_hints() {
    ...
    insta::assert_snapshot!(output, @r"
    @  yqosqzyt test.user@example.com 2001-02-03 08:05:13 0a2fcad6 conflict
    │  (empty) boom-cont-2
    ×  royxmykx test.user@example.com 2001-02-03 08:05:12 b4b3a0d2 conflict
    │  (empty) boom-cont
    ×    mzvwutvl test.user@example.com 2001-02-03 08:05:11 c622b751 conflict
    ├─╮  (empty) boom
    ...
    insta::assert_snapshot!(output, @r"
    The working copy has no changes.
    Working copy  (@) : yqosqzyt 0a2fcad6 (conflict) (empty) boom-cont-2
    Parent commit (@-): royxmykx b4b3a0d2 (conflict) (empty) boom-cont
    ...
    insta::assert_snapshot!(output, @r"
    The working copy has no changes.
    Working copy  (@) : [1m[38;5;13my[38;5;8mqosqzyt[39m [38;5;12m0a[38;5;8m2fcad6[39m [38;5;9m(conflict)[39m [38;5;10m(empty)[39m boom-cont-2[0m
    Parent commit (@-): [1m[38;5;5mr[0m[38;5;8moyxmykx[39m [1m[38;5;4mb4[0m[38;5;8mb3a0d2[39m [38;5;1m(conflict)[39m [38;5;2m(empty)[39m boom-cont
    ...
    insta::assert_snapshot!(output, @r"
    @  wqnwkozp test.user@example.com 2001-02-03 08:05:20 63c3eb1a
    │  fixed 2
    ○  kmkuslsw test.user@example.com 2001-02-03 08:05:19 55ba78e0
    │  fixed 1
    ×  yqosqzyt test.user@example.com 2001-02-03 08:05:13 0a2fcad6 conflict
    │  (empty) boom-cont-2
    ×  royxmykx test.user@example.com 2001-02-03 08:05:12 b4b3a0d2 conflict
    ...
    Working copy changes:
    M conflicted.txt
    Working copy  (@) : wqnwkozp 63c3eb1a fixed 2
    Parent commit (@-): kmkuslsw 55ba78e0 fixed 1
    [EOF]
    ");
    ...
    Working copy changes:
    M conflicted.txt
    Working copy  (@) : kmkuslsw 55ba78e0 fixed 1
    Parent commit (@-): yqosqzyt 0a2fcad6 (conflict) (empty) boom-cont-2
...
fn test_status_simplify_conflict_sides() {
    ...
    @r"
    The working copy has no changes.
    Working copy  (@) : nkmrtpmo a77f1628 conflict | (conflict) (empty) conflict

...
fn test_status_display_relevant_working_commit_conflict_hints() {
    ...
    insta::assert_snapshot!(output, @r"
    @  yqosqzyt test.user@example.com 2001-02-03 08:05:13 23c1e67f conflict
    │  (empty) boom-cont-2
    ×  royxmykx test.user@example.com 2001-02-03 08:05:12 dd1612b2 conflict
    │  (empty) boom-cont
    ×    mzvwutvl test.user@example.com 2001-02-03 08:05:11 5f9b0658 conflict
    ├─╮  (empty) boom
    ...
    insta::assert_snapshot!(output, @r"
    The working copy has no changes.
    Working copy  (@) : yqosqzyt 23c1e67f (conflict) (empty) boom-cont-2
    Parent commit (@-): royxmykx dd1612b2 (conflict) (empty) boom-cont
    ...
    insta::assert_snapshot!(output, @r"
    The working copy has no changes.
    Working copy  (@) : [1m[38;5;13my[38;5;8mqosqzyt[39m [38;5;12m2[38;5;8m3c1e67f[39m [38;5;9m(conflict)[39m [38;5;10m(empty)[39m boom-cont-2[0m
    Parent commit (@-): [1m[38;5;5mr[0m[38;5;8moyxmykx[39m [1m[38;5;4md[0m[38;5;8md1612b2[39m [38;5;1m(conflict)[39m [38;5;2m(empty)[39m boom-cont
    ...
    insta::assert_snapshot!(output, @r"
    @  wqnwkozp test.user@example.com 2001-02-03 08:05:20 5259f835
    │  fixed 2
    ○  kmkuslsw test.user@example.com 2001-02-03 08:05:19 5c540cf7
    │  fixed 1
    ×  yqosqzyt test.user@example.com 2001-02-03 08:05:13 23c1e67f conflict
    │  (empty) boom-cont-2
    ×  royxmykx test.user@example.com 2001-02-03 08:05:12 dd1612b2 conflict
    ...
    Working copy changes:
    M conflicted.txt
    Working copy  (@) : wqnwkozp 5259f835 fixed 2
    Parent commit (@-): kmkuslsw 5c540cf7 fixed 1
    [EOF]
    ");
    ...
    Working copy changes:
    M conflicted.txt
    Working copy  (@) : kmkuslsw 5c540cf7 fixed 1
    Parent commit (@-): yqosqzyt 23c1e67f (conflict) (empty) boom-cont-2
...
fn test_status_simplify_conflict_sides() {
    ...
    @r"
    The working copy has no changes.
    Working copy  (@) : nkmrtpmo 3132628c conflict | (conflict) (empty) conflict

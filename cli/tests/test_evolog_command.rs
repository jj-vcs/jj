...
fn test_evolog_with_or_without_diff() {
    ...
    │  my description
    │  -- operation 62ae1cc47b77 snapshot working copy
    ×  rlvkpnrz/1 test.user@example.com 2001-02-03 08:05:09 cdf175ef (hidden) (conflict)
    │  my description
    │  -- operation 24b64dad146b rebase commit 51e08f95160c897080d035d330aead3ee6ed5588
    ...
    │  [1mmy description[0m
    │  [38;5;8m--[39m operation [38;5;4m62ae1cc47b77[39m snapshot working copy
    ...
    │  my description
    │  [38;5;8m--[39m operation [38;5;4m24b64dad146b[39m rebase commit 51e08f95160c897080d035d330aead3ee6ed5588
...
fn test_evolog_with_custom_symbols() {
    ...
    $  rlvkpnrz test.user@example.com 2001-02-03 08:05:10 33c10ace
    │  my description
    │  -- operation 7a1ba554dbfc snapshot working copy
    ┝  rlvkpnrz/1 test.user@example.com 2001-02-03 08:05:09 cdf175ef (hidden) (conflict)
    │  my description
    │  -- operation 24b64dad146b rebase commit 51e08f95160c897080d035d330aead3ee6ed5588
    ┝  rlvkpnrz/2 test.user@example.com 2001-02-03 08:05:09 51e08f95 (hidden)

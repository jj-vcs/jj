...
fn test_rewrite_immutable_commands() {
    ...
    │  (no description set)
    │ ◆  mzvwutvl test.user@example.com 2001-02-03 08:05:12 main f06a424c conflict
    ╭─┤  merge
    │ │
    │ ~
    │
    ...
    insta::assert_snapshot!(output, @r#"
    ------- stderr -------
    Error: Commit f06a424c7cf4 is immutable
    Hint: Could not modify commit: mzvwutvl f06a424c main | (conflict) merge
    Hint: Immutable commits are used to protect shared history.
    Hint: For more information, see:
          - https://jj-vcs.github.io/jj/latest/config/#set-of-immutable-commits
          - `jj help -k config`, "Set of immutable commits"

...
fn test_squash_partial() {
    ...
    │  M file1
    │  M file2
    ○  kkmpptxz test.user@example.com 2001-02-03 08:05:36 b git_head() 0f38c564
    │  (no description set)
    │  M file1
    │  M file2
    │  A file3
...
fn test_squash_from_multiple_partial_no_op() {
    ...
    insta::assert_snapshot!(output, @r"
    @    6dfc239e2ba3 d
    ├─╮  -- operation c49e7fbc44e9 (2001-02-03 08:05:13) squash commits into fdb92bc249a019337e7fa3f6c6fa74a762dd20b5
    │ ○  b1a17f79a1a5 b
    │ │  -- operation ef9d80a159cc (2001-02-03 08:05:10) snapshot working copy
    │ ○  d8b7d57239ca b
    │    -- operation 447529aed9cc (2001-02-03 08:05:09) new empty commit
    ○  fdb92bc249a0 d
    │  -- operation aa95bbc697b0 (2001-02-03 08:05:12) snapshot working copy
    ○  af709ccc1ca9 d
       -- operation 4d1410029e8e (2001-02-03 08:05:11) new empty commit
    [EOF]
    ");

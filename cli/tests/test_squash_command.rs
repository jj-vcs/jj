...
fn test_squash_working_copy_restore_descendants() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy now at: kxryzmor 7f82b2f5 (no description set)
    ...
    //  BUG: The current commit should become empty!
    insta::assert_snapshot!(output, @r"
    D x
    [EOF]
    ");
...
fn test_squash_from_to_restore_descendants() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy now at: kpqxywon b9282f63 f | (no description set)
    Parent commit      : yostqsxw aa2e7fda e | (no description set)
    Parent commit      : mzvwutvl 58a0b64e c | (no description set)
    [EOF]
    ");
    insta::assert_snapshot!(run_log(), @r"
    @    b9282f636615 f

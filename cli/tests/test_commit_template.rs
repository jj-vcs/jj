...
fn test_log_builtin_templates_colored_debug() {
    ...
    insta::assert_snapshot!(render(r#"builtin_log_oneline"#), @r"
    [1m[38;5;2m<<node working_copy mutable::@>>[0m  [1m[38;5;13m<<log working_copy mutable change_id shortest prefix::r>>[38;5;8m<<log working_copy mutable change_id shortest rest::lvkpnrz>>[39m<<log working_copy mutable:: >>[38;5;9m<<log working_copy mutable email placeholder::(no email set)>>[39m<<log working_copy mutable:: >>[38;5;14m<<log working_copy mutable committer timestamp local format::2001-02-03 08:05:08>>[39m<<log working_copy mutable:: >>[38;5;13m<<log working_copy mutable bookmarks name::my-bookmark>>[39m<<log working_copy mutable:: >>[38;5;12m<<log working_copy mutable commit_id shortest prefix::d>>[38;5;8m<<log working_copy mutable commit_id shortest rest::c315397>>[39m<<log working_copy mutable:: >>[38;5;10m<<log working_copy mutable empty::(empty)>>[39m<<log working_copy mutable:: >>[38;5;10m<<log working_copy mutable empty description placeholder::(no description set)>>[39m<<log working_copy mutable::>>[0m
    <<node mutable::○>>  [1m[38;5;5m<<log mutable change_id shortest prefix::q>>[0m[38;5;8m<<log mutable change_id shortest rest::pvuntsm>>[39m<<log mutable:: >>[38;5;3m<<log mutable author email local::test.user>>[39m<<log mutable:: >>[38;5;6m<<log mutable committer timestamp local format::2001-02-03 08:05:07>>[39m<<log mutable:: >>[1m[38;5;4m<<log mutable commit_id shortest prefix::2>>[0m[38;5;8m<<log mutable commit_id shortest rest::30dd059>>[39m<<log mutable:: >>[38;5;2m<<log mutable empty::(empty)>>[39m<<log mutable:: >>[38;5;2m<<log mutable empty description placeholder::(no description set)>>[39m<<log mutable::>>
    [1m[38;5;14m<<node immutable::◆>>[0m  [1m[38;5;5m<<log immutable change_id shortest prefix::z>>[0m[38;5;8m<<log immutable change_id shortest rest::zzzzzzz>>[39m<<log immutable:: >>[38;5;2m<<log immutable root::root()>>[39m<<log immutable:: >>[1m[38;5;4m<<log immutable commit_id shortest prefix::0>>[0m[38;5;8m<<log immutable commit_id shortest rest::0000000>>[39m<<log immutable::>>
    [EOF]
    ");

    insta::assert_snapshot!(render(r#"builtin_log_compact"#), @r"
    [1m[38;5;2m<<node working_copy mutable::@>>[0m  [1m[38;5;13m<<log working_copy mutable change_id shortest prefix::r>>[38;5;8m<<log working_copy mutable change_id shortest rest::lvkpnrz>>[39m<<log working_copy mutable:: >>[38;5;9m<<log working_copy mutable email placeholder::(no email set)>>[39m<<log working_copy mutable:: >>[38;5;14m<<log working_copy mutable committer timestamp local format::2001-02-03 08:05:08>>[39m<<log working_copy mutable:: >>[38;5;13m<<log working_copy mutable bookmarks name::my-bookmark>>[39m<<log working_copy mutable:: >>[38;5;12m<<log working_copy mutable commit_id shortest prefix::d>>[38;5;8m<<log working_copy mutable commit_id shortest rest::c315397>>[39m<<log working_copy mutable::>>[0m
    │  [1m[38;5;10m<<log working_copy mutable empty::(empty)>>[39m<<log working_copy mutable:: >>[38;5;10m<<log working_copy mutable empty description placeholder::(no description set)>>[39m<<log working_copy mutable::>>[0m
    <<node mutable::○>>  [1m[38;5;5m<<log mutable change_id shortest prefix::q>>[0m[38;5;8m<<log mutable change_id shortest rest::pvuntsm>>[39m<<log mutable:: >>[38;5;3m<<log mutable author email local::test.user>><<log mutable author email::@>><<log mutable author email domain::example.com>>[39m<<log mutable:: >>[38;5;6m<<log mutable committer timestamp local format::2001-02-03 08:05:07>>[39m<<log mutable:: >>[1m[38;5;4m<<log mutable commit_id shortest prefix::2>>[0m[38;5;8m<<log mutable commit_id shortest rest::30dd059>>[39m<<log mutable::>>
    │  [38;5;2m<<log mutable empty::(empty)>>[39m<<log mutable:: >>[38;5;2m<<log mutable empty description placeholder::(no description set)>>[39m<<log mutable::>>
    [1m[38;5;14m<<node immutable::◆>>[0m  [1m[38;5;5m<<log immutable change_id shortest prefix::z>>[0m[38;5;8m<<log immutable change_id shortest rest::zzzzzzz>>[39m<<log immutable:: >>[38;5;2m<<log immutable root::root()>>[39m<<log immutable:: >>[1m[38;5;4m<<log immutable commit_id shortest prefix::0>>[0m[38;5;8m<<log immutable commit_id shortest rest::0000000>>[39m<<log immutable::>>
    [EOF]
    ");
    ...
    insta::assert_snapshot!(render(r#"builtin_log_detailed"#), @r"
    [1m[38;5;2m<<node working_copy mutable::@>>[0m  <<log::Commit ID: >>[38;5;4m<<log commit_id::dc31539712c7294d1d712cec63cef4504b94ca74>>[39m<<log::>>
    ...
    │  <<log::>>
    <<node mutable::○>>  <<log::Commit ID: >>[38;5;4m<<log commit_id::230dd059e1b059aefc0da06a2e5a7dbf22362f22>>[39m<<log::>>

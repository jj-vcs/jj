...
fn test_report_conflicts() {
    ...
    Working copy  (@) now at: zsuskuln 5d53f3eb (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz 40489d6f (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 2 commits:
      kkmpptxz 40489d6f (conflict) C
      rlvkpnrz de94b8f3 (conflict) B
    ...
    Working copy  (@) now at: zsuskuln 7519c457 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz 60449894 (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict
    New conflicts appeared in 2 commits:
      kkmpptxz 60449894 (conflict) C
      rlvkpnrz 790fb326 (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv d40b652f (conflict) (empty) (no description set)
    Parent commit (@-)      : rlvkpnrz 790fb326 (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    [EOF]
...
fn test_report_conflicts_with_divergent_commits() {
    ...
    Rebased 3 commits to destination
    Working copy  (@) now at: zsuskuln/1 e02883df (divergent) (conflict) C2
    Parent commit (@-)      : kkmpptxz 648eb47d (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 3 commits:
      zsuskuln/0 44792f99 (divergent) (conflict) C3
      zsuskuln/1 e02883df (divergent) (conflict) C2
      kkmpptxz 648eb47d (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    the first conflicted commit:
      jj new kkmpptxz
    Then use `jj resolve`, or edit the conflict markers in the file directly.
    ...
    ------- stderr -------
    Rebased 1 commits to destination
    Working copy  (@) now at: zsuskuln/0 8b69b20e (divergent) (conflict) C2
    Parent commit (@-)      : zzzzzzzz 00000000 (empty) (no description set)
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 1 commits:
      zsuskuln/0 8b69b20e (divergent) (conflict) C2
    Hint: To resolve the conflicts, start by creating a commit on top of
    ...
    Rebased 1 commits to destination
    New conflicts appeared in 1 commits:
      zsuskuln/0 40ef637b (divergent) (conflict) C3
    Hint: To resolve the conflicts, start by creating a commit on top of
    the conflicted commit:
      jj new zsuskuln/0
    Then use `jj resolve`, or edit the conflict markers in the file directly.

...
fn test_report_conflicts() {
    ...
    Working copy  (@) now at: zsuskuln 99d42f69 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz a695f78b (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 2 commits:
      kkmpptxz a695f78b (conflict) C
      rlvkpnrz fdfc12a9 (conflict) B
    ...
    Working copy  (@) now at: zsuskuln 11dc5ef5 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz 85e01c12 (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict
    New conflicts appeared in 2 commits:
      kkmpptxz 85e01c12 (conflict) C
      rlvkpnrz 1a93c459 (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv 187ab530 (conflict) (empty) (no description set)
    Parent commit (@-)      : rlvkpnrz 1a93c459 (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    [EOF]
...
fn test_report_conflicts_with_divergent_commits() {
    ...
    Rebased 3 commits to destination
    Working copy  (@) now at: zsuskuln?? 9f715ec7 (conflict) C2
    Parent commit (@-)      : kkmpptxz 15853aff (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 3 commits:
      zsuskuln?? c88978d3 (conflict) C3
      zsuskuln?? 9f715ec7 (conflict) C2
      kkmpptxz 15853aff (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    the first conflicted commit:
      jj new kkmpptxz
    Then use `jj resolve`, or edit the conflict markers in the file directly.
    ...
    ------- stderr -------
    Rebased 1 commits to destination
    Working copy  (@) now at: zsuskuln?? f62c5801 (conflict) C2
    Parent commit (@-)      : zzzzzzzz 00000000 (empty) (no description set)
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 1 commits:
      zsuskuln?? f62c5801 (conflict) C2
    Hint: To resolve the conflicts, start by creating a commit on top of

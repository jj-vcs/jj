...
fn test_report_conflicts() {
    ...
    Working copy  (@) now at: zsuskuln 109d2114 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz 9fc618bb (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 2 commits:
      kkmpptxz 9fc618bb (conflict) C
      rlvkpnrz 6621bdfa (conflict) B
    ...
    Working copy  (@) now at: zsuskuln ee54bb75 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz 6cb3fa16 (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict
    New conflicts appeared in 2 commits:
      kkmpptxz 6cb3fa16 (conflict) C
      rlvkpnrz 546826e0 (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv 9ed7d6fa (conflict) (empty) (no description set)
    Parent commit (@-)      : rlvkpnrz 546826e0 (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    [EOF]
...
fn test_report_conflicts_with_divergent_commits() {
    ...
    Rebased 3 commits to destination
    Working copy  (@) now at: zsuskuln?? c2a4dcde (conflict) C2
    Parent commit (@-)      : kkmpptxz b8910d7b (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 3 commits:
      zsuskuln?? 5b173f8a (conflict) C3
      zsuskuln?? c2a4dcde (conflict) C2
      kkmpptxz b8910d7b (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    the first conflicted commit:
      jj new kkmpptxz
    Then use `jj resolve`, or edit the conflict markers in the file directly.
    ...
    ------- stderr -------
    Rebased 1 commits to destination
    Working copy  (@) now at: zsuskuln?? d828efd0 (conflict) C2
    Parent commit (@-)      : zzzzzzzz 00000000 (empty) (no description set)
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 1 commits:
      zsuskuln?? d828efd0 (conflict) C2
    Hint: To resolve the conflicts, start by creating a commit on top of

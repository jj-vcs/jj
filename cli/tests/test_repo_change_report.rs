...
fn test_report_conflicts() {
    ...
    Working copy  (@) now at: zsuskuln 92775041 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz cb7db9cf (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 2 commits:
      kkmpptxz cb7db9cf (conflict) C
      rlvkpnrz 702ba279 (conflict) B
    ...
    Working copy  (@) now at: zsuskuln f7eaf8c8 (conflict) (empty) (no description set)
    Parent commit (@-)      : kkmpptxz e343a76b (conflict) C
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict
    New conflicts appeared in 2 commits:
      kkmpptxz e343a76b (conflict) C
      rlvkpnrz b6e13281 (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv b1703458 (conflict) (empty) (no description set)
    Parent commit (@-)      : rlvkpnrz b6e13281 (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    [EOF]
...
fn test_report_conflicts_with_divergent_commits() {
    ...
    Rebased 3 commits to destination
    Working copy  (@) now at: zsuskuln?? f132b031 (conflict) C2
    Parent commit (@-)      : kkmpptxz 1bf4e493 (conflict) B
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 3 commits:
      zsuskuln?? a9d3d239 (conflict) C3
      zsuskuln?? f132b031 (conflict) C2
      kkmpptxz 1bf4e493 (conflict) B
    Hint: To resolve the conflicts, start by creating a commit on top of
    the first conflicted commit:
      jj new kkmpptxz
    Then use `jj resolve`, or edit the conflict markers in the file directly.
    ...
    ------- stderr -------
    Rebased 1 commits to destination
    Working copy  (@) now at: zsuskuln?? 087596c9 (conflict) C2
    Parent commit (@-)      : zzzzzzzz 00000000 (empty) (no description set)
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict including 1 deletion
    New conflicts appeared in 1 commits:
      zsuskuln?? 087596c9 (conflict) C2
    Hint: To resolve the conflicts, start by creating a commit on top of

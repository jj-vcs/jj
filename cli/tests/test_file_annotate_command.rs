...
fn test_annotate_conflicted() {
    ...
    yostqsxw test.use 2001-02-03 08:05:15    3: %%%%%%% Changes from base (qpvuntsm a5daff01) to side #1 (zsuskuln 30cd4478)
    yostqsxw test.use 2001-02-03 08:05:15    4: +new text from new commit 1
    yostqsxw test.use 2001-02-03 08:05:15    5: +++++++ Contents of side #2 (royxmykx ad312256)

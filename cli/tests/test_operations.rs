...
fn test_op_diff() {
    ...
    let output = work_dir.run_jj(["op", "log"]);
    insta::assert_snapshot!(output, @"
    @  b22c1e6675e7 test-username@host.example.com 2001-02-03 04:05:10.000 +07:00 - 2001-02-03 04:05:10.000 +07:00
    │  track remote bookmark bookmark-1@origin
    │  args: jj bookmark track bookmark-1
    ○  48ea2e690772 test-username@host.example.com 2001-02-03 04:05:09.000 +07:00 - 2001-02-03 04:05:09.000 +07:00
    ...
    insta::assert_snapshot!(output, @"
    From operation: b22c1e6675e7 (2001-02-03 08:05:10) track remote bookmark bookmark-1@origin
      To operation: b22c1e6675e7 (2001-02-03 08:05:10) track remote bookmark bookmark-1@origin
    [EOF]
    ");
    ...
    let output = work_dir.run_jj(["op", "diff", "--from", "@-", "--to", "@"]);
    insta::assert_snapshot!(output, @"
    From operation: 48ea2e690772 (2001-02-03 08:05:09) fetch from git remote(s) origin
      To operation: b22c1e6675e7 (2001-02-03 08:05:10) track remote bookmark bookmark-1@origin
    ...
    let output = work_dir.run_jj(["op", "log"]);
    insta::assert_snapshot!(output, @"
    @    3389ff1a62f3 test-username@host.example.com 2001-02-03 04:05:21.000 +07:00 - 2001-02-03 04:05:21.000 +07:00
    ├─╮  reconcile divergent operations
    │ │  args: jj log
    ○ │  ff0d30122bc0 test-username@host.example.com 2001-02-03 04:05:19.000 +07:00 - 2001-02-03 04:05:19.000 +07:00
    ...
    │ ○  401f05eb9492 test-username@host.example.com 2001-02-03 04:05:20.000 +07:00 - 2001-02-03 04:05:20.000 +07:00
    ...
    insta::assert_snapshot!(output, @"
    From operation: ff0d30122bc0 (2001-02-03 08:05:19) point bookmark bookmark-1 to commit e8849ae12c709f2321908879bc724fdb2ab8a781
      To operation: 3389ff1a62f3 (2001-02-03 08:05:21) reconcile divergent operations
    ...
    insta::assert_snapshot!(output, @"
    From operation: 401f05eb9492 (2001-02-03 08:05:20) point bookmark bookmark-1 to commit 4ff6253913375c6ebdddd8423c11df3b3f17e331
      To operation: 3389ff1a62f3 (2001-02-03 08:05:21) reconcile divergent operations
    ...
    insta::assert_snapshot!(output, @"
    From operation: 3389ff1a62f3 (2001-02-03 08:05:21) reconcile divergent operations
      To operation: 5e8aada277e8 (2001-02-03 08:05:25) fetch from git remote(s) origin
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 5e8aada277e8 (2001-02-03 08:05:25) fetch from git remote(s) origin
      To operation: a3922d080f78 (2001-02-03 08:05:27) create bookmark bookmark-2 pointing to commit e1a239a57eb15cefc5910198befbbbe2b43c47af
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: a3922d080f78 (2001-02-03 08:05:27) create bookmark bookmark-2 pointing to commit e1a239a57eb15cefc5910198befbbbe2b43c47af
      To operation: b6d180d54337 (2001-02-03 08:05:29) track remote bookmark bookmark-2@origin
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: b6d180d54337 (2001-02-03 08:05:29) track remote bookmark bookmark-2@origin
      To operation: e8f187d1a382 (2001-02-03 08:05:33) new empty commit
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: e8f187d1a382 (2001-02-03 08:05:33) new empty commit
      To operation: 96c5eff64e37 (2001-02-03 08:05:35) point bookmark bookmark-1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 96c5eff64e37 (2001-02-03 08:05:35) point bookmark bookmark-1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
      To operation: c2e3f0c58e81 (2001-02-03 08:05:37) delete bookmark bookmark-2
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: c2e3f0c58e81 (2001-02-03 08:05:37) delete bookmark bookmark-2
      To operation: 3e1ef9389fc0 (2001-02-03 08:05:39) push all tracked bookmarks to git remote origin
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: 3e1ef9389fc0 (2001-02-03 08:05:39) push all tracked bookmarks to git remote origin
      To operation: a47db1edd108 (2001-02-03 08:05:41) set tag tag1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
    ...
    let output = work_dir.run_jj(["op", "diff"]);
    insta::assert_snapshot!(output, @"
    From operation: a47db1edd108 (2001-02-03 08:05:41) set tag tag1 to commit 96f3a57c9a4a4ae7bb45d1eafe32fe3b6e33f458
      To operation: edd41054b9ca (2001-02-03 08:05:45) delete tag tag1
...
fn test_op_diff_word_wrap() {
    ...
    From operation: 2908183476e1 (2001-02-03 08:05:07) add git remote origin
      To operation: 05362554f351 (2001-02-03 08:05:08) snapshot working copy
...
fn test_op_show() {
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    3cf0653728ed test-username@host.example.com 2001-02-03 04:05:17.000 +07:00 - 2001-02-03 04:05:17.000 +07:00
    reconcile divergent operations
    args: jj log
    [EOF]
    ");
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    8b227a358f75 test-username@host.example.com 2001-02-03 04:05:19.000 +07:00 - 2001-02-03 04:05:19.000 +07:00
    fetch from git remote(s) origin
    args: jj git fetch
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    f6699b4565bc test-username@host.example.com 2001-02-03 04:05:21.000 +07:00 - 2001-02-03 04:05:21.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    acb5b683b941 test-username@host.example.com 2001-02-03 04:05:23.000 +07:00 - 2001-02-03 04:05:23.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    fb6c0142d8ac test-username@host.example.com 2001-02-03 04:05:27.000 +07:00 - 2001-02-03 04:05:27.000 +07:00
    new empty commit
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    a8b24192f08c test-username@host.example.com 2001-02-03 04:05:29.000 +07:00 - 2001-02-03 04:05:29.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    d6403d4f07a5 test-username@host.example.com 2001-02-03 04:05:31.000 +07:00 - 2001-02-03 04:05:31.000 +07:00
    ...
    let output = work_dir.run_jj(["op", "show"]);
    insta::assert_snapshot!(output, @"
    0a03a6196c19 test-username@host.example.com 2001-02-03 04:05:33.000 +07:00 - 2001-02-03 04:05:33.000 +07:00

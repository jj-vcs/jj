...
fn test_chmod_regular_conflict() {
    ...
    Working copy  (@) now at: yostqsxw 13a11440 conflict | (conflict) conflict
...
fn test_chmod_file_dir_deletion_conflicts() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: kmkuslsw ba95b887 file_deletion | (conflict) file_deletion
    ...
    New conflicts appeared in 1 commits:
      kmkuslsw ba95b887 file_deletion | (conflict) file_deletion

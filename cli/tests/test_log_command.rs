...
fn test_log_with_diff_stats() {
    ...
    let output = work_dir.run_jj([
        ...
        self.diff().stat().files().map(
            |f| f.status_char() ++ " " ++ f.status() ++ " " ++ f.lines_added() ++ " " ++ f.lines_removed() ++ " " ++ f.source_path() ++ " " ++ f.path()
        ).join("\n")
        "#
    ]);
    insta::assert_snapshot!(output, @r"
    ...
    │  removed file4 file4
    │  renamed file5 file6
    │  M modified 1 0 file1 file1
    │  M modified 0 1 file2 file2
    │  M modified 1 1 file3 file3
    │  D removed 0 1 file4 file4
    │  R renamed 0 0 file5 file6
    ○  added file1 file1
    │  added file2 file2
    │  added file3 file3
    │  added file4 file4
    │  added file5 file5
    │  A added 1 0 file1 file1
    │  A added 2 0 file2 file2
    │  A added 1 0 file3 file3
    │  A added 1 0 file4 file4
    │  A added 2 0 file5 file5
    ◆
    [EOF]
    ");
}

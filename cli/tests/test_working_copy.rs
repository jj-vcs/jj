...
fn test_materialize_and_snapshot_different_conflict_markers() {
    ...
    line 1
    <<<<<<< Side #1 (rlvkpnrz df1cdd77) (Conflict 1 of 1)
    line 2 - a
    line 3
    ||||||| Base (qpvuntsm 2205b3ac)
    line 2
    line 3
    =======
    line 2 - b
    line 3 - b
    >>>>>>> Side #2 (zsuskuln 68dcce1b) (Conflict 1 of 1 ends)
    ");
    ...
    @@ -2,7 +2,7 @@
     <<<<<<< Conflict 1 of 1
     +++++++ Contents of side #1 (rlvkpnrz df1cdd77)
     line 2 - a
    -line 3
    +line 3 - a
     ------- Contents of base (qpvuntsm 2205b3ac)
     line 2
     line 3
    [EOF]
    ");
...
fn test_conflict_marker_length_stored_in_working_copy() {
    ...
    line 1
    <<<<<<<<<<< Conflict 1 of 1
    %%%%%%%%%%% Changes from base (qpvuntsm 2205b3ac) to side #1 (rlvkpnrz ccf9527c)
    -line 2
    -line 3
    +line 2 - left
    +line 3 - left
    +++++++++++ Contents of side #2 (zsuskuln d7acaf48)
    ======= fake marker
    line 2 - right
    ======= fake marker
    line 3
    ...
    Current tree: MergedTreeId { tree_ids: Conflicted([TreeId("381273b50cf73f8c81b3f1502ee89e9bbd6c1518"), TreeId("771f3d31c4588ea40a8864b2a981749888e596c2"), TreeId("f56b8223da0dab22b03b8323ced4946329aeb4e0")]), labels: Some(Conflicted(["rlvkpnrz ccf9527c", "qpvuntsm 2205b3ac", "zsuskuln d7acaf48"])) }
    Normal { <executable> }           309 <timestamp> Some(MaterializedConflictData { conflict_marker_len: 11 }) "file"
    [EOF]
    "#);
    ...
    Current tree: MergedTreeId { tree_ids: Conflicted([TreeId("381273b50cf73f8c81b3f1502ee89e9bbd6c1518"), TreeId("771f3d31c4588ea40a8864b2a981749888e596c2"), TreeId("3329c18c95f7b7a55c278c2259e9c4ce711fae59")]), labels: Some(Conflicted(["rlvkpnrz ccf9527c", "qpvuntsm 2205b3ac", "zsuskuln d7acaf48"])) }
    ...
    Current tree: MergedTreeId { tree_ids: Resolved(TreeId("6120567b3cb2472d549753ed3e4b84183d52a650")), labels: None }

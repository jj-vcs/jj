...
fn test_resolution() {
    ...
    <<<<<<< Side #1 (zsuskuln 45537d53) (Conflict 1 of 1)
    a
    ||||||| Base (rlvkpnrz 1792382a)
    base
    =======
    b
    >>>>>>> Side #2 (royxmykx 89d1b299) (Conflict 1 of 1 ends)
    ");
    insta::assert_snapshot!(work_dir.run_jj(["diff", "--git"]), @r"
    diff --git a/file b/file
    --- a/file
...
fn test_baseless_conflict_input_files() {
    ...
    insta::assert_snapshot!(work_dir.read_file("file"), @r"
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes from base (rlvkpnrz 2308e5a2) to side #1 (zsuskuln e3c7222d)
    +a
    +++++++ Contents of side #2 (royxmykx 1f2c13ec)
    b
    >>>>>>> Conflict 1 of 1 ends
    ");
...
fn test_simplify_conflict_sides() {
    ...
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes from base (rlvkpnrz ca4643d3) to side #1 (zsuskuln f302fbd1)
    -base
    +1
    +++++++ Contents of side #2 (royxmykx 128a2559)
    2
    >>>>>>> Conflict 1 of 1 ends
    ");
...
fn test_edit_delete_conflict_input_files() {
    ...
    insta::assert_snapshot!(work_dir.read_file("file"), @r"
    <<<<<<< Conflict 1 of 1
    +++++++ Contents of side #1 (zsuskuln 45537d53)
    a
    %%%%%%% Changes from base (rlvkpnrz 1792382a) to side #2 (royxmykx d213fd81)
    -base
    >>>>>>> Conflict 1 of 1 ends
    ");
...
fn test_resolve_conflicts_with_executable() {
    ...
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes from base (rlvkpnrz b90abfa7) to side #1 (mzvwutvl 86f7f0e3)
    -base1
    +a1
    +++++++ Contents of side #2 (yqosqzyt 36361412)
    b1
    >>>>>>> Conflict 1 of 1 ends
    "
    );
...
fn test_pass_path_argument() {
    ...
    +++++++ Contents of side #1 (zsuskuln 45537d53)
    a
    ------- Contents of base (rlvkpnrz 1792382a)
    base
    +++++++ Contents of side #2 (royxmykx 89d1b299)
    b
    >>>>>>> Conflict 1 of 1 ends
...
fn test_resolve_long_conflict_markers() {
    ...
    insta::assert_snapshot!(work_dir.read_file("file"), @r"
    <<<<<<<<<<< Conflict 1 of 1
    +++++++++++ Contents of side #1 (zsuskuln 10d994ef)
    <<<<<<< a
    ----------- Contents of base (rlvkpnrz 04dceede)
    ======= base
    +++++++++++ Contents of side #2 (royxmykx 7f215575)
    >>>>>>> b
    >>>>>>>>>>> Conflict 1 of 1 ends
    "
    );
...
fn test_multiple_conflicts() {
    ...
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes from base (rlvkpnrz fa081b8c) to side #1 (zsuskuln 2c821f70)
    -first base
    +first a
    +++++++ Contents of side #2 (royxmykx 4c2029de)
    first b
    >>>>>>> Conflict 1 of 1 ends
    ");
...
fn test_multiple_conflicts_with_error() {
    ...
    insta::assert_snapshot!(work_dir.read_file("file1"), @r"
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes from base (rlvkpnrz 6591ac1d) to side #1 (zsuskuln 6c31698c)
    -base1
    +a1
    +++++++ Contents of side #2 (royxmykx ba0a5538)
    b1
    >>>>>>> Conflict 1 of 1 ends
    "
    );
...
fn test_resolve_with_contents_of_side() {
    ...
    insta::assert_snapshot!(work_dir.read_file("file"), @r"
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes from base (rlvkpnrz ed3e06b2) to side #1 (zsuskuln 72dced6e)
    -base
    +a
    +++++++ Contents of side #2 (royxmykx e5747f42)
    b
    >>>>>>> Conflict 1 of 1 ends
    ");

...
fn test_restore() {
    ...
    Working copy  (@) now at: kkmpptxz 1977526a (conflict) (no description set)
    ...
    New conflicts appeared in 1 commits:
      kkmpptxz 1977526a (conflict) (no description set)
...
fn test_restore_conflicted_merge() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv a3e46332 conflict | (conflict) (empty) conflict

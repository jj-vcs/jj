...
fn test_restore() {
    ...
    Working copy  (@) now at: kkmpptxz d88b34cd (conflict) (no description set)
    ...
    New conflicts appeared in 1 commits:
      kkmpptxz d88b34cd (conflict) (no description set)
...
fn test_restore_conflicted_merge() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv 1a2dfb8c conflict | (conflict) (empty) conflict
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv 0f434b47 conflict | (conflict) (empty) conflict
    Parent commit (@-)      : zsuskuln 45537d53 a | a
    Parent commit (@-)      : royxmykx 89d1b299 b | b
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:

...
fn test_restore() {
    ...
    Working copy  (@) now at: kkmpptxz 2e2fd50d (conflict) (no description set)
    ...
    New conflicts appeared in 1 commits:
      kkmpptxz 2e2fd50d (conflict) (no description set)
...
fn test_restore_conflicted_merge() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv fac1cce9 conflict | (conflict) (empty) conflict
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: vruxwmqv 6d2813ed conflict | (conflict) (empty) conflict
    Parent commit (@-)      : zsuskuln 45537d53 a | a
    Parent commit (@-)      : royxmykx 89d1b299 b | b
    Added 0 files, modified 1 files, removed 0 files
    Warning: There are unresolved conflicts at these paths:

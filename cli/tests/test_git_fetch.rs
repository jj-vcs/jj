...
fn test_git_fetch_undo() {
    ...
    insta::assert_snapshot!(output, @"
    ------- stderr -------
    Undid operation: e3c1626eb094 (2001-02-03 08:05:20) fetch from git remote(s) origin
    Restored to operation: d74b893c7fc2 (2001-02-03 08:05:07) add git remote origin
    [EOF]
    ");
...
fn test_git_fetch_remotely_rewritten() {
    ...
    │  (empty) bookmarked
    │  -- operation ead49d2610af fetch from git remote(s) origin
...
fn test_git_fetch_remotely_rewritten_descendants() {
    ...
    │  (empty) bookmarked 2
    │  -- operation 7e2be8a55442 fetch from git remote(s) origin
    ...
    │  (empty) bookmarked 1
    │  -- operation bdcea8db0094 fetch from git remote(s) origin

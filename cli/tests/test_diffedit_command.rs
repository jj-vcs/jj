...
fn test_diffedit_external_tool_conflict_marker_style() {
    ...
    insta::assert_snapshot!(output, @r"
    ------- stderr -------
    Working copy  (@) now at: mzvwutvl fdaf0582 (conflict) (empty) (no description set)
    ...
    Working copy  (@) : mzvwutvl fdaf0582 (conflict) (empty) (no description set)
    Parent commit (@-): rlvkpnrz 74e448a1 side-a
    Parent commit (@-): zsuskuln 6982bce7 side-b
    Warning: There are unresolved conflicts at these paths:
    file    2-sided conflict
...
fn test_diffedit_merge() {
    ...
    ------- stderr -------
    Rebased 1 descendant commits
    Working copy  (@) now at: yqosqzyt da11b84f (conflict) (empty) (no description set)
    Parent commit (@-)      : royxmykx 0f2d91ff (conflict) merge
    Added 0 files, modified 0 files, removed 1 files
    Warning: There are unresolved conflicts at these paths:

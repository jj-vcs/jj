...
fn test_diffedit_external_tool_conflict_marker_style() {
    ...
    line 2.1
    line 2.2
    %%%%%%% Changes from base (qpvuntsm 9bd2e004) to side #2 (zsuskuln 6982bce7)
    -line 2
    +line 2.3
    >>>>>>> Conflict 1 of 2 ends
    line 3
    <<<<<<< Conflict 2 of 2
    %%%%%%% Changes from base (qpvuntsm 9bd2e004) to side #1 (rlvkpnrz 74e448a1)
    -line 4
    +line 4.1
    +++++++ Contents of side #2 (zsuskuln 6982bce7)
    line 4.2
...
fn test_diffedit_merge() {
    ...
    insta::assert_snapshot!(output, @r"
    <<<<<<< Conflict 1 of 1
    %%%%%%% Changes from base (qpvuntsm fc6f5e82) to side #1 (mzvwutvl e3b18dc7)
    -a
    +c
    +++++++ Contents of side #2 (rlvkpnrz 7027fb26)
    b
    >>>>>>> Conflict 1 of 1 ends
    [EOF]
    ");

...
fn test_tag_list() {
    ...
    conflicted_tag: royxmykx 13c4e819 (empty) commit3
    ...
    [38;5;5mconflicted_tag[39m: [1m[38;5;5mr[0m[38;5;8moyxmykx[39m [1m[38;5;4m13[0m[38;5;8mc4e819[39m [38;5;2m(empty)[39m commit3
    ...
    present: true
    conflict: false
    normal_target: commit3
    removed_targets:
    added_targets: commit3
    [test_tag]
    present: true
    conflict: false

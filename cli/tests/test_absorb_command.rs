...
fn test_absorb_simple() {
    ...
    ○    kkmpptxz 5810eb0f 1
    ├─╮  -- operation 7590da890ca6 (2001-02-03 08:05:14) absorb changes into 1 commits
    │ ○  yqosqzyt hidden 39b42898 (no description set)
    │ │  -- operation 1f22799ba5fc (2001-02-03 08:05:14) snapshot working copy
    │ ○  yqosqzyt hidden 977269ac (empty) (no description set)
    │    -- operation bcccb0a86663 (2001-02-03 08:05:13) absorb changes into 2 commits
    ○    kkmpptxz hidden bd7d4016 1
    ├─╮  -- operation bcccb0a86663 (2001-02-03 08:05:13) absorb changes into 2 commits
    │ ○  mzvwutvl hidden 0b307741 (no description set)
    │ │  -- operation 717b14a34fcd (2001-02-03 08:05:13) snapshot working copy
    │ ○  mzvwutvl hidden f2709b4e (empty) (no description set)
    │    -- operation 12c05721b0cc (2001-02-03 08:05:11) new empty commit
    ○  kkmpptxz hidden 1553c5e8 1
    │  -- operation 2db8584b17c6 (2001-02-03 08:05:10) snapshot working copy
    ○  kkmpptxz hidden eb943711 (empty) 1
       -- operation 8c7dc9505997 (2001-02-03 08:05:09) new empty commit
    [EOF]
    ");
    insta::assert_snapshot!(get_evolog(&work_dir, "description(2)"), @r"
    ○    zsuskuln dd109863 2
    ├─╮  -- operation bf709122ad8d (2001-02-03 08:05:15) absorb changes into 1 commits
    │ ○  vruxwmqv hidden 761492a8 (no description set)
    │ │  -- operation efd270fcfcb1 (2001-02-03 08:05:15) snapshot working copy
    ...
    │  -- operation 5f1fe3c56905 (2001-02-03 08:05:11) snapshot working copy
    ○  zsuskuln hidden 561fbce9 (empty) 2
       -- operation 449264432e00 (2001-02-03 08:05:10) new empty commit
    [EOF]
    ");
}

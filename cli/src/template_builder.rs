    ...
    map.insert(
        ...
        |_language, _diagnostics, _build_ctx, self_property, function| {
            ...
            if let Some(limit_node) = limit_node {
                let limit_property =
                    expect_usize_expression(_language, _diagnostics, _build_ctx, limit_node)?;
                let out_property =
...
mod tests {
    ...
    fn test_string_method() {
        ...
        insta::assert_snapshot!(env.render_ok(r#""a,b,c,d".split(",", 0)"#), @"a b c d");
        ...
        insta::assert_snapshot!(env.render_ok(r#""a1b2c3".split(regex:'\d+')"#), @"a b c");
        ...
        insta::assert_snapshot!(env.render_ok(r#""hello world".split(regex-i:"WORLD")"#), @"hello");

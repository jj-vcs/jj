...
See [here](../comparisons/git-compatibility.md#colocated-jujutsugit-repos) for details.
...
[revset function](../reference/revsets.md#functions) returns commits that have no descendants
...
Expressions in this language are called "revsets". See [here](../reference/revsets.md) for

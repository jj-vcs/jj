...
bookmarks"](../reference/config.md#automatic-tracking-of-bookmarks) for details.
...
[colocated-workspaces]: ../comparisons/git-compatibility.md#colocated-jujutsugit-repos

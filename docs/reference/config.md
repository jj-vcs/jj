...
page](../concepts/conflicts.md#conflict-markers).
...
See [Colocated Jujutsu/Git workspaces](../comparisons/git-compatibility.md#colocated-jujutsugit-repos)
...
[ignore files](../concepts/working-copy.md#ignored-files) are never tracked automatically.
...
copy. However, first [ignore](../concepts/working-copy.md#ignored-files) them or remove them
...
This is particularly useful if you have [multiple workspaces](../concepts/working-copy.md#workspaces)
and want to avoid manually updating each one.

For more information on stale working copies, see the [working copy
documentation](../concepts/working-copy.md#stale-working-copy).

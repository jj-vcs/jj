...
Most revsets search only the [visible commits](../concepts/glossary.md#visible-commits).
...
* `author_date(pattern)`: Commits with [author dates](../concepts/glossary.md#author-date)
...
* `committer_date(pattern)`: Commits with
  [committer dates](../concepts/glossary.md#committer-date) matching the specified [date
...
* `divergent()`: Commits that are [divergent](../concepts/glossary.md#divergent-change).
...
[operation]: ../concepts/glossary.md#operation

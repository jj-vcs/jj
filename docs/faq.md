...
To view the elided revisions, change the [revset expression](reference/revsets.md) so it
...
drawbacks](comparisons/git-compatibility.md#colocated-jujutsugit-repos) but the most
important ones are:
...
- If the working copy commit or its parent contain any conflicted files, tools
  ...
  conflicts](technical-details/conflicts.md)). See
...
[git.private-commits](reference/config.md#set-of-private-commits):
...
[glossary_divergence]: concepts/glossary.md#divergent-change
[glossary_change_offset]: concepts/glossary.md#change-offset
...
[bookmarks_conflicts]: concepts/bookmarks.md#conflicts

[change]: concepts/glossary.md#change
[change ID]: concepts/glossary.md#change-id
[colocated]: concepts/glossary.md#colocated-workspaces
[commit ID]: concepts/glossary.md#commit-id
[commits]: concepts/glossary.md#commit
[config]: reference/config.md

[gerrit-integration]: https://gist.github.com/thoughtpolice/8f2fd36ae17cd11b8e7bd93a70e31ad6
[gitignore]: https://git-scm.com/docs/gitignore

[operator]: reference/revsets.md#operators

...
This creates a [colocated
workspace](git-compatibility.md#colocated-jujutsugit-workspaces) (`.jj/` next to
`.git/`), so you can use both `jj` and `git` commands in the same directory. See
[Creating a repo backed by an existing Git

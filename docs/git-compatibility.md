...
creates a [colocated](#co-located-jujutsugit-repos) Jujutsu workspace, there
will be a `.jj` directory and a `.git` directory.
...
## <a name="co-located-jujutsugit-repos"></a>Colocated Jujutsu/Git workspaces

...
[`working-copy.eol-conversion`](../reference/config.md#eol-conversion-setting), similar to
...
files based on a [heuristic](../reference/config.md#binary-file-detection). This behavior is
...
config docs](../reference/config.md#pager) for more details.

...
[colocates](../comparisons/git-compatibility.md#colocated-jujutsugit-repos) the `.jj` and
...
```shell
$ nvim docs/getting-started/tutorial.md
$ # Do some more work.
...
The hyphen after `your-feature` comes from the [revset](../reference/revsets.md) syntax.
...
that aren't [colocated](../comparisons/git-compatibility.md#colocated-jujutsugit-repos)
...
[auto-bookmark]: ../reference/config.md#automatic-tracking-of-bookmarks

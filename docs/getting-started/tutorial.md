...
of revisions to list. The flag accepts a ["revset"](../reference/revsets.md), which is an
...
[the revset documentation](../reference/revsets.md) for all revset operators and functions.
...
[`ui.diff-editor` option](../reference/config.md#editing-diffs); those docs also explain how
